...
export function premadeRowToMap(row: Record<string, any>): PremadeMap {
  ...
  return {
    ...
    location_elevation_m: row.location_elevation_m ?? null,
    location_metadata_source: row.location_metadata_source ?? null,
    location_metadata_enriched_at: row.location_metadata_enriched_at ?? null,
    category: category,
    categories,
    tagline: row.tagline || '',
