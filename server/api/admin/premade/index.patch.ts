...
const Body = z.object({
  ...
  location_elevation_m: z.number().nullable().optional(),
  location_metadata_source: z.string().max(160).nullable().optional(),
  location_metadata_enriched_at: z.string().datetime().nullable().optional(),
