...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    runtimeSurfaces: ['Admin Atlas Lab', 'Editor MapPreview', 'Browserless proof/final renders', 'Analytics attribution ledger'],
  ...
  },
  {
    ...
    runtimeSurfaces: ['Admin Atlas Lab', 'Editor MapPreview', 'Browserless renders', 'Tile build workers'],
    sources: ['Generated contour vector PMTiles', 'Future COG DEM mosaics', 'Future hillshade raster tiles', 'Hydrography and landcover layers'],
