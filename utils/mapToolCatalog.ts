...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    capabilities: ['Separate water polygons', 'Waterways', 'Road/transportation polygons with line fallback styling', 'Trails/paths', 'Buildings', 'Landuse', 'Parks/forests', 'Place labels', 'POI classes', 'First-party light/dark Toner variants with high-contrast road linework and soft dot patterns for named protected park areas', 'Noto Sans glyphs for Atlas Lab labels'],
    ...
    notes: 'Production now has validated contiguous-US, North America, New Zealand, Northern Spain/Camino, Mount Fuji/Japan, and Patagonia Andes Planetiler PMTiles base atlases in R2 alongside the Driftless lab pack. tiles.radmaps.studio is live through the Cloudflare Worker custom domain, with the Vercel shim retained as fallback during DNS cache transition. Toner Light and Toner Dark use these vector layers plus generated MapLibre dot patterns on named protected park/preserve polygons to replace the Stadia visual dependency for first-party Toner without blanket texture. The next coverage queue is tracked in atlas/coverage-targets.json: keep production QA tight, split wider Honshu/Japan or use a larger runner after exit 137 on ubuntu-latest, and keep larger Europe/global work behind source-size and demand gates. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
