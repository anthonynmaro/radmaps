...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    appNames: ['radmaps-vector', 'radmaps-roads', 'radmaps-water', 'radmaps-labels', 'RadMaps Toner', 'RadMaps Field Topo', 'RadMaps Contour Wash', 'RadMaps Watercolor Wash', 'RadMaps Night Relief', 'RadMaps Simple Contour'],
    ...
    notes: 'Staging now has validated contiguous-US and North America Planetiler PMTiles base atlases in R2; production still points at Driftless until Worker, Atlas Lab, editor, Browserless, attribution, analytics, and rollback QA pass. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
