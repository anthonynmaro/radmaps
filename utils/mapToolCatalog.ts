...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    notes: 'Staging now has validated contiguous-US, North America, and New Zealand Planetiler PMTiles base atlases in R2. tiles.radmaps.studio is live through the Cloudflare Worker custom domain, with the Vercel shim retained as fallback during DNS cache transition. The next coverage queue is tracked in atlas/coverage-targets.json: promote North America after QA, review New Zealand staging proofs, then build small Patagonia, Northern Spain/Camino, and Honshu/Japan proof packs before any larger Europe/global work. Production still points at Driftless until Atlas Lab, editor, Browserless, attribution, analytics, and rollback QA pass. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
