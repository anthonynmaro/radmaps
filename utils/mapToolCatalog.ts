...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    notes: 'Production now has validated contiguous-US, North America, New Zealand, Northern Spain/Camino, Mount Fuji/Japan, and Patagonia Andes Planetiler PMTiles base atlases in R2 alongside the Driftless lab pack. The next coverage queue is tracked in atlas/coverage-targets.json v2 with a $200 total build budget gate, z16 POI/outdoor-route hotspot overlays, dry-run cost logging, and 24x36 print QA before rollout. tiles.radmaps.studio is live through the Cloudflare Worker custom domain, with the Vercel shim retained as fallback during DNS cache transition. Toner Light and Toner Dark use these vector layers plus generated MapLibre dot patterns on named protected park/preserve polygons to replace the Stadia visual dependency for first-party Toner without blanket texture. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
