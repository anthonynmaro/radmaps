...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    runtimeSurfaces: ['Admin Atlas Lab live PMTiles previews through /api/atlas/tiles', 'Editor MapPreview', 'Browserless proof/final renders', 'Analytics attribution ledger'],
    sources: ['Cloudflare R2 PMTiles generated by Planetiler, Protomaps, or Tilemaker', 'Same-origin MVT tile endpoint backed by PMTiles range reads'],
    ...
    notes: 'Staging now has a validated contiguous-US Planetiler PMTiles base atlas in R2; Atlas Lab serves that archive through a same-origin tile endpoint so MapLibre receives ordinary MVT tiles, with showcase contour overlays. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
    ...
    sources: ['Generated contour vector PMTiles for Driftless, Yosemite, Rocky Mountain, Smokies, and North Shore showcase regions', 'Configured Midwest and US phase-one terrain packs in atlas/terrain-regions.json', 'Future COG DEM mosaics', 'Future hillshade raster tiles', 'Hydrography and landcover layers'],
    capabilities: ['Regional contour packs at z8-14', 'Lowland 10-20 ft minor contour targets', 'Mountain/canyon 40 ft minor contour targets', 'Contour intervals by print scale', 'Hillshade intensity/color art direction', 'Slope/aspect textures', 'Tree/landcover masks', 'Water/shoreline enhancement'],
    ...
    notes: 'Driftless, Yosemite, Rocky Mountain, Smokies, and North Shore contour packs are live in R2 and wired into Atlas Lab showcase switching. Full-US base coverage is live. The terrain build plan now has named Midwest and US phase-one packs so GitHub Actions or a self-hosted runner can build/upload contours remotely while keeping each PMTiles artifact bounded.',
  },
  {
    id: 'naip-aerial',
