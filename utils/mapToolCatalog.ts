...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    notes: 'Staging now has validated contiguous-US and North America Planetiler PMTiles base atlases in R2. tiles.radmaps.studio is live through the Cloudflare Worker custom domain, with the Vercel shim retained as fallback during DNS cache transition. The next coverage queue is tracked in atlas/coverage-targets.json: promote North America first, then build small Patagonia, Northern Spain/Camino, Honshu/Japan, and New Zealand proof packs before any larger Europe/global work. Production still points at Driftless until Atlas Lab, editor, Browserless, attribution, analytics, and rollback QA pass. This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
