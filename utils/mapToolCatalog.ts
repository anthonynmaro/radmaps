...
export const MAP_TOOL_CATALOG: MapToolCatalogItem[] = [
  ...
  },
  {
    ...
    appNames: ['radmaps-vector', 'radmaps-roads', 'radmaps-water', 'radmaps-labels'],
    usedByPresets: ['Future default for route-only', 'road-network', 'contour-art', 'native-toner', 'new house styles'],
    runtimeSurfaces: ['Editor MapPreview', 'Browserless proof/final renders', 'Analytics attribution ledger'],
    sources: ['PMTiles/MBTiles vector tiles generated by Planetiler, Protomaps, or Tilemaker'],
    ...
    trackingKeys: ['atlas_version', 'tile_schema_version', 'bbox_hash', 'preset', 'enabled_layers', 'render_class'],
    notes: 'This is the strategic replacement for most commercial vector/raster basemap dependency.',
  },
  {
    ...
    status: 'planned',
    costModel: 'self-hosted',
    appNames: ['radmaps-terrain', 'radmaps-contours', 'radmaps-hillshade', 'radmaps-landcover'],
    usedByPresets: ['Future contour-art', 'natural-topo successor', 'field-journal', 'topographic successor'],
    runtimeSurfaces: ['Editor MapPreview', 'Browserless renders', 'Tile build workers'],
    sources: ['COG DEM mosaics', 'Generated contour vectors', 'Hillshade raster tiles', 'Hydrography and landcover layers'],
    capabilities: ['Contour intervals by print scale', 'Hillshade intensity/color art direction', 'Slope/aspect textures', 'Tree/landcover masks', 'Water/shoreline enhancement'],
    ...
    trackingKeys: ['terrain_atlas_version', 'dem_source', 'contour_interval', 'hillshade_style', 'render_class'],
    notes: 'The main creative moat: RadMaps-specific topographic rendering, not generic web cartography.',
  },
  {
    id: 'naip-aerial',
