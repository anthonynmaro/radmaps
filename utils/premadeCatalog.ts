...
export function draftPremadeFromMap(map: SourceMapForPremade, slug: string): Omit<PremadeMap, 'id'> {
  ...
  return {
    ...
    location_elevation_m: map.location_elevation_m ?? null,
    location_metadata_source: map.location_metadata_source ?? null,
    location_metadata_enriched_at: map.location_metadata_enriched_at ?? null,
    category: 'hikes',
    categories: ['hikes'],
