...
export const POSTER_COMPOSITIONS: Record<PosterCompositionId, PosterCompositionProfile> = {
  ...
  'modernist-block': {
    ...
    ...STANDARD_BOTTOM,
    ...BASE_PROFILE,
    headerPadding: '3cqh calc(5.5cqw + var(--print-bleed, 0px)) calc(3.4cqh + var(--print-bleed, 0px))',
    headerBackground: 'label',
    footerPadding: '1.6cqh calc(5.5cqw + var(--print-bleed, 0px)) calc(1.8cqh + var(--print-bleed, 0px))',
    mapMargin: '0 0 0 9cqw',
    mapBorder: '0 solid transparent',
    statsEmphasis: 'large',
    showSideRail: true,
  },
