...
export const POSTER_COMPOSITIONS: Record<PosterCompositionId, PosterCompositionProfile> = {
  ...
  'travel-banner': {
    ...
    titleAlign: 'center',
    ...BASE_PROFILE,
    headerPadding: '2.8cqh calc(4.8cqw + var(--print-bleed, 0px)) 3cqh',
  ...
  'riso-stack': {
    ...
    titleAlign: 'left',
    ...BASE_PROFILE,
    headerPadding: 'calc(5.1cqh + var(--print-bleed, 0px)) calc(7cqw + var(--print-bleed, 0px)) 2.2cqh',
    mapMargin: '0 5cqw 0.8cqh',
  ...
  'blueprint-strava': {
    ...
    titleAlign: 'left',
    ...BASE_PROFILE,
    headerPadding: 'calc(3cqh + var(--print-bleed, 0px)) calc(4.4cqw + var(--print-bleed, 0px)) 1.7cqh',
    footerPadding: '1.3cqh calc(4.4cqw + var(--print-bleed, 0px)) calc(1.7cqh + var(--print-bleed, 0px))',
    mapMargin: '0 3.6cqw',
  ...
  'modernist-block': {
    ...
    ...STANDARD_BOTTOM,
    ...BASE_PROFILE,
    headerPadding: '2.8cqh calc(4.75cqw + var(--print-bleed, 0px)) calc(3.1cqh + var(--print-bleed, 0px)) calc(7.7cqw + var(--print-bleed, 0px))',
    headerBackground: 'label',
    footerPadding: '1.5cqh calc(4.75cqw + var(--print-bleed, 0px)) calc(1.7cqh + var(--print-bleed, 0px)) calc(7.7cqw + var(--print-bleed, 0px))',
    mapMargin: '0',
    mapBorder: '0 solid transparent',
    statsEmphasis: 'large',
    showSideRail: true,
  ...
  'brutalist-slab': {
    ...
    ...STANDARD_BOTTOM,
    ...BASE_PROFILE,
    headerPadding: '2.3cqh calc(4.25cqw + var(--print-bleed, 0px)) calc(3.25cqh + var(--print-bleed, 0px))',
    footerPadding: '1.7cqh calc(4.25cqw + var(--print-bleed, 0px)) calc(1.9cqh + var(--print-bleed, 0px))',
    mapMargin: '0',
    mapBorder: '0 solid transparent',
    statsEmphasis: 'large',
  },
