...
| RadMaps Open Vector Atlas | `radmaps-vector`, `radmaps-roads`, `radmaps-water`, `radmaps-labels` | Planned | Self-hosted | Water, waterways, roads, trails, labels, POIs, buildings, landuse, parks/forests | Full vector paint/layout control for layer families | OSM attribution remains unless source data is non-OSM or attribution-free. |
| RadMaps Terrain Atlas | `radmaps-terrain`, `radmaps-contours`, `radmaps-hillshade`, `radmaps-landcover` | Planned | Self-hosted | Contours, hillshade, slope/aspect textures, hydro emphasis, landcover masks | `contour_*`, `hillshade_*`, `terrain_exaggeration`, `land_color`, `water_color` | Depends on selected DEM and landcover sources; prefer public-domain or permissive sources. |
