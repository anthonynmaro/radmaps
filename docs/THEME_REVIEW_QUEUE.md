...
| `copper-night` | `ready-for-review` | 100.0% (`106/106`) | `docs/theme_audit_output/poster-themes/print/copper-night.png` | Claude 09:02 feedback addressed: starfield/summit constellation are visible, the route fixture is lower and softer, title subtitle uses Tre Cime di Lavaredo, and the Dolomiti / 10.5 km / JUL 2025 footer is preserved. |
