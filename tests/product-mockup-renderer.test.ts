...
describe('product mockup renderer', () => {
  ...
  it('adds generated acrylic hardware above the replacement artwork', async () => {
    ...
    expect(chromeBoxes.top_left).toMatchObject({ left: 940, top: 446, width: 41, height: 41 })
    expect(chromeBoxes.top_right.left + chromeBoxes.top_right.width).toBe(2076)
    expect(chromeBoxes.bottom_right.top + chromeBoxes.bottom_right.height).toBe(2156)
  }, 10000)
