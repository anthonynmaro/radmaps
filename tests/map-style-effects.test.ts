...
describe('RadMaps Atlas style integration', () => {
  ...
  it('renders Risograph routes as GPX-source two-ink misregistered plates', () => {
    ...
    expect(config.route_width).toBe(4.8)
    expect(config.route_opacity).toBe(0.9)
    ...
    expect(layerById(style, 'route-line-riso-blue')?.paint?.['line-width']).toBe(4.7)
    expect(layerById(style, 'route-line-riso-blue')?.paint?.['line-opacity']).toBe(0.81)
    expect(layerById(style, 'route-line-riso-blue')?.paint?.['line-translate']).toEqual([3, 3])
    expect(layerById(style, 'route-line-riso-pink-overprint')?.paint?.['line-color']).toBe('#FF4F7B')
    expect(layerById(style, 'route-line-riso-pink-overprint')?.paint?.['line-width']).toBe(6)
    expect(layerById(style, 'route-line-riso-pink-overprint')?.paint?.['line-opacity']).toBeCloseTo(0.198)
    expect(layerById(style, 'route-line-riso-pink-overprint')?.paint?.['line-translate']).toEqual([-1.2, -0.8])
    expect(layerById(style, 'route-line-riso-pink-overprint')?.paint?.['line-blur']).toBe(0.9)
    expect(layerById(style, 'route-line')?.paint?.['line-color']).toBe('#FF4F7B')
    expect(layerById(style, 'route-line')?.paint?.['line-width']).toBe(4.8)
  ...
  it('applies Risograph map tokens as the style contract', () => {
    ...
    expect(config.route_color).toBe('#FF4F7B')
    expect(config.route_width).toBe(4.8)
    expect(layerById(style, 'background')?.paint?.['background-color']).toBe('#F4F0E3')
    expect(layerById(style, 'radmaps-simple-contour-landcover')?.paint?.['fill-color']).toBe('#F4F0E3')
  ...
  it('applies Field Journal map tokens as the naturalist spread contract', () => {
    ...
    expect(config.route_width).toBe(3.35)
    expect(config.route_opacity).toBe(0.94)
    ...
    expect(layerById(style, 'route-line')?.paint?.['line-width']).toBe(3.35)
    expect(layerById(style, 'route-line')?.paint?.['line-opacity']).toBe(0.94)
    expect(layerById(style, 'route-line-journal-wash')?.paint?.['line-color']).toBe('#A17B4D')
    expect(layerById(style, 'route-line-journal-wash')?.paint?.['line-width']).toBe(6.95)
    expect(layerById(style, 'route-line-journal-wash')?.paint?.['line-opacity']).toBe(0.188)
    expect(layerById(style, 'route-line-journal-drybrush')?.paint?.['line-color']).toBe('#6A4A2A')
    expect(layerById(style, 'route-line-journal-drybrush')?.paint?.['line-width']).toBe(3)
    expect(layerById(style, 'route-line-journal-drybrush')?.paint?.['line-opacity']).toBe(0.5076)
  })
  ...
  it('renders Shaded Relief route with a GPX-source terrain shadow beneath the route ink', () => {
    ...
    expect(config.hillshade_intensity).toBeGreaterThan(0.5)
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-shadow-color']).toBe('#4B3524')
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-highlight-color']).toBe('#FFF2CF')
    ...
    expect(layerById(style, 'route-line-relief-shadow')?.paint?.['line-color']).toBe('#3F2B22')
    expect(layerById(style, 'route-line-relief-shadow')?.paint?.['line-width']).toBe(7.8)
    expect(layerById(style, 'route-line-relief-shadow')?.paint?.['line-opacity']).toBe(0.216)
    expect(layerById(style, 'route-line-relief-shadow')?.paint?.['line-blur']).toBe(1.8)
    expect(layerById(style, 'route-line-relief-shadow')?.paint?.['line-translate']).toEqual([1.2, 1.1])
    expect(layerById(style, 'route-line-relief-highlight')?.paint?.['line-color']).toBe('#F1D9A0')
    expect(layerById(style, 'route-line-relief-highlight')?.paint?.['line-width']).toBeCloseTo(3.1, 6)
    expect(layerById(style, 'route-line-relief-highlight')?.paint?.['line-opacity']).toBeCloseTo(0.252, 6)
    expect(layerById(style, 'route-line-relief-highlight')?.paint?.['line-blur']).toBe(0.7)
    expect(layerById(style, 'route-line-relief-highlight')?.paint?.['line-translate']).toEqual([-1.0, -0.9])
  ...
  it('renders Sea Chart route as a GPX-source charted course with waypoint marks', () => {
    ...
    expect(config.route_color).toBe('#B23A6A')
    ...
    expect(layerById(style, 'route-line-sea-course-shadow')?.paint?.['line-width']).toBe(5.4)
    expect(layerById(style, 'route-line-sea-course-shadow')?.paint?.['line-opacity']).toBeCloseTo(0.162)
    expect(layerById(style, 'route-line-sea-course-shadow')?.paint?.['line-blur']).toBe(1.1)
    expect(layerById(style, 'route-line-sea-course')?.paint?.['line-color']).toBe('#B23A6A')
    expect(layerById(style, 'route-line-sea-course')?.paint?.['line-width']).toBe(2.4)
    expect(layerById(style, 'route-line-sea-course')?.paint?.['line-opacity']).toBeCloseTo(0.378)
    expect(layerById(style, 'route-line-sea-course')?.paint?.['line-dasharray']).toEqual([1, 9])
    ...
    expect(layerById(style, 'route-line-sea-waypoints')?.layout?.['symbol-spacing']).toBe(58)
    expect(layerById(style, 'route-line-sea-waypoints')?.layout?.['text-field']).toBe('•')
    expect(layerById(style, 'route-line-sea-waypoints')?.layout?.['text-size']).toBe(14)
    expect(layerById(style, 'route-line-sea-waypoints')?.paint?.['text-color']).toBe('#B23A6A')
    expect(layerById(style, 'route-line-sea-waypoints')?.paint?.['text-opacity']).toBe(0.81)
    expect(layerById(style, 'route-line-sea-waypoints')?.paint?.['text-halo-color']).toBe('#EDE6D2')
  ...
  it('applies Shaded Relief map tokens as the terrain print contract', () => {
    ...
    expect(config.hillshade_intensity).toBe(0.58)
    expect(config.hillshade_highlight).toBe(0.40)
    expect(config.show_grid).toBe(false)
    expect(config.show_start_pin).toBe(false)
    expect(config.show_finish_pin).toBe(false)
    expect(config.route_color).toBe('#6C271B')
    expect(config.route_width).toBe(4.6)
    expect(config.contour_detail).toBe(6)
    expect(config.contour_opacity).toBe(0.58)
    expect(config.contour_color).toBe('#967C52')
    expect(config.contour_major_color).toBe('#5E4A31')
    expect(config.water_color).toBe('#9FBDB3')
    expect(config.land_color).toBe('#DCC899')
    expect(layerById(style, 'background')?.paint?.['background-color']).toBe('#DCC899')
    expect(layerById(style, 'radmaps-natural-landcover')?.paint?.['fill-color']).toBe('#DCC899')
    expect(layerById(style, 'radmaps-natural-landcover')?.paint?.['fill-opacity']).toBe(0.98)
    expect(layerById(style, 'radmaps-natural-park')?.paint?.['fill-color']).toBe('#C9B57F')
    expect(layerById(style, 'radmaps-natural-park')?.paint?.['fill-opacity']).toBe(0.28)
    expect(layerById(style, 'radmaps-natural-water')?.paint?.['fill-color']).toBe('#9FBDB3')
    expect(layerById(style, 'radmaps-natural-water')?.paint?.['fill-opacity']).toBe(0.38)
    expect(layerById(style, 'radmaps-natural-waterway')?.paint?.['line-color']).toBe('#71988F')
    expect(layerById(style, 'radmaps-natural-waterway')?.paint?.['line-opacity']).toBe(0.42)
    expect(layerById(style, 'radmaps-natural-roads-major')).toBeUndefined()
    expect(layerById(style, 'radmaps-natural-roads-minor')).toBeUndefined()
    ...
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-shadow-color']).toBe('#4B3524')
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-highlight-color']).toBe('#FFF2CF')
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-accent-color']).toBe('#7B5733')
    expect(layerById(style, 'hillshade')?.paint?.['hillshade-exaggeration']).toBe(0.58)
    expect(layerById(style, 'contours-minor')?.paint?.['line-color']).toBe('#967C52')
    expect(layerById(style, 'contours-minor')?.paint?.['line-opacity']).toEqual([
      'interpolate', ['linear'], ['zoom'], 5, 0.54, 14, 0.54 * 0.9,
    ])
    expect(layerById(style, 'contours-minor')?.paint?.['line-width']).toEqual([
      'interpolate', ['linear'], ['zoom'], 5, 0.68 * 0.8, 14, 0.68,
    ])
    expect(layerById(style, 'contours-major')?.paint?.['line-color']).toBe('#5E4A31')
    expect(layerById(style, 'contours-major')?.paint?.['line-opacity']).toBe(0.70)
    expect(layerById(style, 'route-line')?.paint?.['line-color']).toBe('#6C271B')
  ...
  it('applies Sea Chart map tokens as the nautical chart contract', () => {
    ...
    expect(config.font_family).toBe('Libre Baskerville')
    expect(config.body_font_family).toBe('IBM Plex Sans')
    expect(config.background_color).toBe('#EDE6D2')
    expect(config.label_bg_color).toBe('#EDE6D2')
    ...
    expect(layerById(style, 'background')?.paint?.['background-color']).toBe('#EDE6D2')
    expect(layerById(style, 'radmaps-simple-contour-landcover')?.paint?.['fill-color']).toBe('#EDE6D2')
    expect(layerById(style, 'radmaps-simple-contour-landcover')?.paint?.['fill-opacity']).toBe(0.98)
    expect(layerById(style, 'radmaps-simple-contour-water')?.paint?.['fill-color']).toBe('#D7E7E0')
    expect(layerById(style, 'radmaps-simple-contour-water')?.paint?.['fill-opacity']).toBe(0.34)
    expect(layerById(style, 'radmaps-simple-contour-waterway')?.paint?.['line-color']).toBe('#9DC6BC')
    expect(layerById(style, 'radmaps-simple-contour-waterway')?.paint?.['line-opacity']).toBe(0.24)
    expect(layerById(style, 'radmaps-simple-contour-roads-major')).toBeUndefined()
    expect(layerById(style, 'radmaps-simple-contour-roads-minor')).toBeUndefined()
    expect(layerById(style, 'radmaps-simple-contour-trails')).toBeUndefined()
    expect(layerById(style, 'radmaps-simple-contour-poi-labels')).toBeUndefined()
    expect(layerById(style, 'radmaps-simple-contour-place-labels')).toBeUndefined()
    expect(layerById(style, 'contours-minor')?.paint?.['line-color']).toBe('#A9C2B4')
    expect(layerById(style, 'contours-minor')?.paint?.['line-opacity']).toEqual([
      'interpolate', ['linear'], ['zoom'], 5, 0.20, 14, 0.20 * 0.9,
    ])
    expect(layerById(style, 'contours-minor')?.paint?.['line-width']).toEqual([
      'interpolate', ['linear'], ['zoom'], 5, 0.50 * 0.8, 14, 0.50,
    ])
    expect(layerById(style, 'contours-major')?.paint?.['line-color']).toBe('#6F9583')
    expect(layerById(style, 'contours-major')?.paint?.['line-opacity']).toBe(0.30)
    expect(layerById(style, 'contours-major')?.paint?.['line-width']).toEqual([
      'interpolate', ['linear'], ['zoom'], 5, 0.62 * 1.5, 14, 0.62 * 2.5,
    ])
    expect(layerById(style, 'route-line')?.paint?.['line-color']).toBe('#B23A6A')
  ...
  it('applies Cartouche Place map tokens as the engraved place-frame contract', () => {
    ...
    expect(config.roads_color).toBe('#9A8F76')
    expect(config.roads_opacity).toBe(0.52)
    expect(config.show_place_labels).toBe(true)
    expect(config.place_labels_color).toBe('#5C513F')
    expect(config.place_labels_opacity).toBe(0.64)
    expect(config.show_poi_labels).toBe(true)
    expect(config.poi_labels_color).toBe('#6F604A')
    expect(config.poi_labels_opacity).toBe(0.28)
    expect(config.show_contours).toBe(false)
    expect(config.show_hillshade).toBe(false)
    expect(config.show_grid).toBe(false)
    expect(config.grid_scope).toBe('map')
    expect(config.grid_opacity).toBe(0.10)
    expect(config.water_color).toBe('#CDD9D0')
    ...
    expect(layerById(style, 'background')?.paint?.['background-color']).toBe('#F1EBDD')
    expect(layerById(style, 'radmaps-alidade-landcover')?.paint?.['fill-color']).toBe('#F1EBDD')
    expect(layerById(style, 'radmaps-alidade-water')?.paint?.['fill-color']).toBe('#CDD9D0')
    expect(layerById(style, 'radmaps-alidade-water')?.paint?.['fill-opacity']).toBe(0.80)
    expect(layerById(style, 'radmaps-alidade-waterway')?.paint?.['line-color']).toBe('#A7B9AF')
    expect(layerById(style, 'radmaps-alidade-waterway')?.paint?.['line-opacity']).toBe(0.56)
    expect(layerById(style, 'radmaps-alidade-roads-major')?.paint?.['line-color']).toBe('#7A6E55')
    expect(layerById(style, 'radmaps-alidade-roads-major')?.paint?.['line-opacity']).toBe(0.54)
    expect(layerById(style, 'radmaps-alidade-roads-minor')?.paint?.['line-color']).toBe('#9A8F76')
    expect(layerById(style, 'radmaps-alidade-roads-minor')?.paint?.['line-opacity']).toBeCloseTo(0.3348, 6)
    expect(layerById(style, 'radmaps-alidade-place-labels')?.paint?.['text-color']).toBe('#5C513F')
    expect(layerById(style, 'radmaps-alidade-place-labels')?.paint?.['text-opacity']).toBe(0.64)
    expect(layerById(style, 'radmaps-alidade-poi-labels')?.paint?.['text-color']).toBe('#6F604A')
  ...
  it('applies Transit Diagram map tokens as the simplified diagram base contract', () => {
    ...
    expect(layerById(style, 'radmaps-simple-contour-roads-major')?.paint?.['line-color']).toBe('#D0CDC4')
    expect(layerById(style, 'radmaps-simple-contour-roads-major')?.paint?.['line-opacity']).toBe(0.16)
    expect(layerById(style, 'radmaps-simple-contour-roads-minor')?.paint?.['line-color']).toBe('#E1DFD8')
    expect(layerById(style, 'radmaps-simple-contour-place-labels')?.paint?.['text-color']).toBe('#6F746F')
    expect(layerById(style, 'radmaps-simple-contour-place-labels')?.paint?.['text-opacity']).toBe(0.22)
    expect(layerById(style, 'radmaps-simple-contour-poi-labels')).toBeUndefined()
    expect(layerById(style, 'contours-minor')).toBeUndefined()
    expect(layerById(style, 'contours-major')).toBeUndefined()
  ...
  it('renders Marathon Bib routes as GPX-source race course ink with mile ticks', () => {
    ...
    expect(layerById(style, 'route-line-bib-shadow')?.paint?.['line-color']).toBe('#0A0A0A')
    ...
    expect(layerById(style, 'route-line-bib-knockout')?.paint?.['line-color']).toBe('#FBFAF4')
    ...
    expect(layerById(style, 'route-line-bib-mile-dashes')?.paint?.['line-color']).toBe('#0A0A0A')
    ...
    expect(layerById(style, 'route-line-bib-mile-ticks')?.paint?.['text-color']).toBe('#0A0A0A')
    expect(layerById(style, 'route-line-bib-mile-ticks')?.paint?.['text-opacity']).toBeCloseTo(0.432)
    expect(layerById(style, 'route-line-bib-mile-ticks')?.paint?.['text-halo-color']).toBe('#FBFAF4')
    ...
    expect(layerById(style, 'route-line-bib-checkpoint-dots')?.paint?.['text-color']).toBe('#FBFAF4')
  ...
  it('renders Botanical routes as GPX-source specimen linework', () => {
    ...
    expect(layerById(style, 'route-line-botanical-pressed')?.paint?.['line-color']).toBe('#9EBB9F')
    expect(layerById(style, 'route-line-botanical-pressed')?.paint?.['line-width']).toBe(10.95)
    expect(layerById(style, 'route-line-botanical-pressed')?.paint?.['line-opacity']).toBe(0.2444)
    expect(layerById(style, 'route-line-botanical-vein')?.paint?.['line-color']).toBe('#536737')
    expect(layerById(style, 'route-line-botanical-vein')?.paint?.['line-width']).toBeCloseTo(3.5, 6)
    expect(layerById(style, 'route-line-botanical-stem-shadow')?.paint?.['line-color']).toBe('#2D3F22')
    expect(layerById(style, 'route-line-botanical-ink-vein')?.paint?.['line-color']).toBe('#F0E7D4')
    expect(layerById(style, 'route-line-botanical-ink-vein')?.paint?.['line-width']).toBe(1.25)
    expect(layerById(style, 'route-line-botanical-leaf-cuts')?.paint?.['line-dasharray']).toEqual([0.22, 5.4])
    expect(layerById(style, 'route-line-botanical-leaf-cuts')?.paint?.['line-color']).toBe('#F0E7D4')
    ...
    expect(layerById(style, 'route-line-botanical-specimen-dots')?.paint?.['text-opacity']).toBe(0.6956)
    expect(layerById(style, 'route-line-botanical-specimen-dots')?.paint?.['text-halo-color']).toBe('#F0E7D4')
  ...
  it('applies Botanical map tokens as the engraved plate contract', () => {
    ...
    expect(config.water_color).toBe('#9EBB9F')
    expect(config.land_color).toBe('#E1D8BE')
    expect(config.route_color).toBe('#31512B')
    expect(config.route_width).toBe(4.35)
    expect(config.route_opacity).toBe(0.94)
    expect(layerById(style, 'background')?.paint?.['background-color']).toBe('#E1D8BE')
    expect(layerById(style, 'radmaps-natural-landcover')?.paint?.['fill-color']).toBe('#E1D8BE')
    expect(layerById(style, 'radmaps-natural-landcover')?.paint?.['fill-opacity']).toBe(0.96)
    expect(layerById(style, 'radmaps-natural-park')?.paint?.['fill-color']).toBe('#B6BE82')
    expect(layerById(style, 'radmaps-natural-park')?.paint?.['fill-opacity']).toBe(0.26)
    expect(layerById(style, 'radmaps-natural-water')?.paint?.['fill-color']).toBe('#9EBB9F')
    expect(layerById(style, 'radmaps-natural-water')?.paint?.['fill-opacity']).toBe(0.32)
    expect(layerById(style, 'radmaps-natural-waterway')?.paint?.['line-color']).toBe('#739779')
    expect(layerById(style, 'radmaps-natural-waterway')?.paint?.['line-opacity']).toBe(0.40)
    expect(layerById(style, 'radmaps-natural-roads-major')).toBeUndefined()
    expect(layerById(style, 'radmaps-natural-roads-minor')).toBeUndefined()
    expect(layerById(style, 'radmaps-natural-place-labels')).toBeUndefined()
    expect(layerById(style, 'radmaps-natural-poi-labels')).toBeUndefined()
